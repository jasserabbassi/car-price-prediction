...
def _load_with_compat(path):
    """joblib.load() that loads models saved with joblib.
    Compatible with both old pickle files (if any still exist)
    and new joblib files.
    """
