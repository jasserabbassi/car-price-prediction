...
class WeightedEnsemble:
    ...
    def __init__(
        ...
        # Only keep models that have weights (filtered to top-K)
        # This ensures serialization is consistent between models and weights
...
def main() -> int:
    ...
    # Don't pickle the ensemble - instead reconstruct it in app.py from base models + weights JSON
    # This avoids serialization issues with the WeightedEnsemble class
